    ...
    return (
      <div className='trElement'>
                  ...
                  <Row className='report-chart-text'>
                    <Col>
                      ...
                      <Card.Text className='text-body'>
                        ...
                        Institute of Graphic Arts) and Google conducted in 2019,
                        61% of designers identify as female, 36% as male, and
                        1.4% as non-binary/gender nonconforming/genderfluid.
                        While the rather sizable percentage of women in the
                        design field does subvert the general expectations of
                        design being a male dominated field, the overwhelming
                        majority of designers are white/Caucasian at 71%. The
                        next largest category is Asian at 36%, Latinx at 8%,
                        multiracial at 5%, Black/African American at 3%, and
                        Native American/First Nations/First People making up
                        less than 1% of designers. When compared to our survey
                        results there is a large shift in the demographics of
                        people surveyed and interviewed. Of the 105 respondents
                        surveyed, 66.7% of our Designers identified as female,
                        25.7% as male, 6.7% as non-binary, 3.8% as gender
                        nonconforming, 1% as trans men, 1% as genderqueer and 1%
                        as 2-spirited. The racial demographics of the Denizen
                        Designers was just as diverse with 41.2% identifying as
                        Black/African American, 29.4% Asian, 28.4% White, 8.4%
                        Hispanic, 2.9% Middle Eastern/Arab, 2.9% American
                        Indian/Alaskan origin and 2% Caribbean or West Indian.
                        This dramatic increase in the amount of diversity, in
                        both race and gender identity, allowed for the Denizen
        ...
        <p>
          ...
          examine the perceptions of access to design; and it is clear from both
          the survey results and the interviews that there are several barriers
          to learning about design, in particular design-for-social-good and
          participatory design (PD). In the US there are only six universities
          that offer design programs with a focus in design-for-social-good or
          participatory design. Due to the small number of university programs
          focusing on PD, the chances of people, both inside and outside of the
          design field, learning about how to conduct participatory design is
          limited. This supports the results from the interviews where many of
        ...
        <p>
          ...
          design-for-social-good/participatory design, there are several global
          design firms such as IDEO and Frog Design which have divisions or
          sister organizations devoted to social impact. In addition to these
          established firms there are also several smaller non/for-profit
          organizations who work on “design for social good,” “AI for social
          good” and “tech for social good.” According to Fast Forward, a company
          that “mobilizes the funding, resources, and support tech nonprofits
          need to create positive impact at scale,” there are 248 tech companies
          in the United States whose missions are to promote social impact. Of
          these organizations there are 55 that are specifically purpose-driven
          creative organizations. The creative focus of these organizations
          varies, but 16 of them are agencies or consultants, 10 focus on
          branding/advertising and 3 focus on public relations. Although these
          creative organizations do a variety of work, there is a strong focus
          on creating design that is marketable. Of course, having a highly
          consumable and accessible campaign or project is an important part of
          ensuring that community work is successful, but this can also be seen
          as a way that design-for-social-good is being capitalized on by
          companies. A 2019 UK survey identified 490 for-profit ‘tech for social
          good’ companies, and 464 non-profits. Of these non-profits, 53% were
        ...
        <p>
          ...
          performative to the communities they are working with. That is not to
          say that the work and resources these organizations provide
          communities are useless, but rather they are not as effective because
          the organizations are not genuinely involved. What differentiates true
          participatory design from the methods that a lot of tech companies
          use, is the direct and authentic involvement of designers in the
          communities. As we saw in our research, when Designers are directly
          involved in the communities they are working with, the Designers feel
          like they are having a more direct, positive, and effective impact.
          Additionally, Designers often received enthusiastic and appreciative
          feedback from their communities when the communities felt that they
          were being genuinely invested in. Given that communities have
          historically been under appreciated for their insights and
          involvement, it is understandable why there is often a lack of trust.
          This distrust is a rocky foundation to build upon, so as one
          interviewee mentioned, “We have to move at the speed of trust, don't
          just try to impose a design or an idea onto people, let it marinate
          with folks. Listen before you design” (Nichlos). When designers
          approach community engagement as simply a box to check in the design
          process and are not willing to genuinely consider community input, it
          deepens feelings of distrust. This fixed mindset some designers have
          when engaging with communities with is important to critique because a
          reoccurring theme in the interviews was that people naturally design.
          While everyone has the ability to design, not everyone had the ability
          to have their work recognized as legitimate design. By professional
          ...
          trust, which in turn promotes more effective and long-lasting change.{' '}
        </p>
      </div>
    );
  }
