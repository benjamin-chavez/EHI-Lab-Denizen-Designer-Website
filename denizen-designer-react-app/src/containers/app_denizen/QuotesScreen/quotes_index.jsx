        ...
        <CardColumns>
          {quoteData &&
            ...
            quoteData.quotes.map((quote) => {
              const shouldShow = quoteCategoryPath == 'all_quotes' ||
                  ...
                  <Fade duration={1500} count={1}>
                    <Card
                      ...
                      onClick={() => {
                        ...
                        setQuoteOwner(`${quote.first_name} ${quote.last_name}`);
                        const participant = participantsData.participants1.find(
                          (item) => item.id === quote.participant_id
                        );
                        setOwnerRole(participant ? participant.designer_type : '');
